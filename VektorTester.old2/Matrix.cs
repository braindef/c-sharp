...
namespace VektorTester
{
	...
	public class Matrix
	{
		...
		public static double determinieren(double[][] m1)
		{
			...
			{
				//if (debug) Console.WriteLine(m1[0][i]*determinieren(Adjunkte(m1, i, 0)));
				//resultat+=m1[0][i]*determinieren(Adjunkte(m1, i, 0));
				//Console.WriteLine(m1[0][i]*determinieren(Adjunkte(Unterdeterminante(m1, i, 0))));
				//Console.WriteLine(m1[0][i]*determinieren(Unterdeterminante(m1, i, 0)));
		...
		{
			double[][] drehmatrix = {new double[] {1,0,0},new double[] {0,Math.Cos(Winkel),-Math.Sin(Winkel)},new double[] {0,Math.Sin(Winkel),Math.Cos(Winkel)}};
			return drehmatrix;
		}
		...
		{
			double[][] drehmatrix = {new double[] {Math.Cos(Winkel),0,Math.Sin(Winkel)},new double[] {0,1,0},new double[] {-Math.Sin(Winkel),0,Math.Cos(Winkel)}};
			return drehmatrix;
		}
	
		public static double[][] zDrehen(double[][] m1, double Winkel) {return null;}
